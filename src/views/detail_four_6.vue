  ...
  <div class="detail">
    <el-row :gutter="30">
      ...
      <el-col :span="8" class="back1"
        ><img src="../assets/images/leidiao.png" width="100%" alt=""
      /></el-col>
      <el-col :span="8"
        ><div class="back2" style="margin-bottom: 20px">
          <template>
...
const { leidiao_only } = require("../../api/index.js");
export default {
  name: "detail_four_1",
  data() {
    return {
      ...
      filterList_2: ["plan_qty", "qty", "total_qty"],
      filterList_3: ["takt", "time_crop_rate"],
      filterList_4: ["item_run", "totaltime_run", "item_eqp", "totaltime_eqp"]
    };
  },
  async mounted() {
    const num = this.$route.params.id.split("_")[0];
    const { data } = await leidiao_only({ num: num });
